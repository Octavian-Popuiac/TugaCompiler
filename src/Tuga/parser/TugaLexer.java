...
public class TugaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"STRING", "FUNCAO", "ESCREVE", "INICIO", "FIM", "ENQUANTO", "SE", "SENAO", 
			"INTEIRO_KW", "REAL_KW", "BOOLEANO_KW", "STRING_KW", "VERDADEIRO", "FALSO", 
			"NAO", "E", "OU", "IGUAL", "DIFERENTE", "RETORNA", "IDENTIFIER", "WS", 
